********************************************************************************
*
*	Do-file:		104_cr_incident_cohort_table.do
*
...
capture log close
log using "$logdir/104_cr_incident_cohort_table.log", replace
	...
	*use "$outdir/incident_cohort_hfref.dta", clear
	...
	foreach year in `years' {
		...
		* Create baseline table
		...
		export delimited using "$tabfigdir/incident_table1_`hftype'_`year'", replace
